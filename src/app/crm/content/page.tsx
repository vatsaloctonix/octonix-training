...
export default function ContentStudioPage() {
  ...
  return (
    <div>
                    ...
                    <TableRow key={course.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end gap-2">
                          <Link href={`/crm/content/courses/${course.id}`}>
      ...
      >
        <form id="crm-index-form" onSubmit={handleSaveIndex} className="space-y-4">
          <Input
            id="indexName"
            label="Index Name"
            value={indexName}
      ...
      <FocusPanel
        ...
        footer={(
          <div className="flex justify-end gap-3">
            ...
            <Button type="submit" form="crm-course-form" loading={saving}>
              {editingCourse ? 'Save Changes' : 'Create Course'}
            </Button>
          </div>
        )}
      >
        <form id="crm-course-form" onSubmit={handleSaveCourse} className="space-y-4">
          <Input
            id="courseTitle"
            label="Course Title"
            value={courseTitle}
